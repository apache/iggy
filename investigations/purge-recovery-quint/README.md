...
The investigation starts from the [purge recovery proposal](https://github.com/apache/iggy/pull/4130)
and compares alternative rules. References to Rust behavior in the model comments
use [this implementation snapshot](https://github.com/diegomrsantos/iggy/tree/fea02d0967b91880e8f3af902936210adacc6ce7).
The models do not define an agreed contract for the current implementation.
