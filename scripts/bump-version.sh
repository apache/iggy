...
CONNECTOR_SOURCE_COMPONENTS="rust-connector-elasticsearch-source rust-connector-fluss-source rust-connector-http-source rust-connector-influxdb-source rust-connector-postgres-source rust-connector-random-source"
