...
class TestConnectivity:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("bad address", "InvalidConnectionString"),
            ("http://{host}:{port}", "InvalidConnectionString"),
            ("tcp://iggy:iggy@{host}:{port}", "InvalidConnectionString"),
            ("{host}:", "InvalidConnectionString"),
            (":{port}", "InvalidConnectionString"),
            ("{host}:not-a-port", "InvalidConnectionString"),
            ("{host}:70000", "InvalidConnectionString"),
            ("iggy+tcp://", "InvalidConnectionString"),
            ("iggy+tcp://iggy:iggy@", "InvalidConnectionString"),
            (
                "iggy+tcp://iggy:iggy@{host}:not-a-port",
                "InvalidConnectionString",
            ),
            ("iggy+tcp://iggy:iggy@{host}:-1", "InvalidConnectionString"),
            ("iggy+tcp://iggy:iggy@{host}:70000", "InvalidConnectionString"),
            (
            ...
            ("iggy+quic://iggy:iggy@127.0.0.1:8080", "CannotCreateEndpoint"),
        ],
    )
