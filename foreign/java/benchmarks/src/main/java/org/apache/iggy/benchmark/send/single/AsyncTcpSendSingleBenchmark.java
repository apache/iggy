...
public class AsyncTcpSendSingleBenchmark extends BaseSingleMessageSendBenchmark {
    ...
    public void send() throws Exception {
        asyncClient
                .messages()
                .sendMessagesAsync(streamId, topicId, Partitioning.partitionId(0L), List.of(message))
                .get();
    }
}
