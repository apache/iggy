...
/**
 * Example test showing how to use the AutoConsumerGroup.
 */
public class AutoConsumerGroupExampleTest {

    @Test
    public void exampleUsage() throws Exception {
        // Skip this test in normal runs as it requires a running Iggy server
        assumeTrue(false, "Skipping example test - requires running Iggy server");
