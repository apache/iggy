...
TEST(LowLevelE2E_Identifier, FromStringRejectsValueLongerThan255Bytes) {
    RecordProperty("description", "Rejects creating a string identifier longer than 255 bytes.");
    iggy::ffi::Identifier identifier;
