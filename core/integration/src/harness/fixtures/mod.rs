...
//! Test fixtures for connector and integration tests.
//!
//! Fixtures manage external dependencies (containers, databases) and provide
//! environment variables to connector configuration.
//!
//! # Example
//!
//! ```ignore
//! use integration::{iggy_harness, harness::fixtures::TestFixture};
//!
//! #[iggy_harness(server(connector(config_path = "postgres/sink.toml")))]
//! async fn test_postgres_sink(client: &IggyClient, fixture: PostgresSinkFixture) {
