...
//! Standard seed functions for MCP and integration tests.
//!
//! Seed functions populate the test server with data before the test body runs.
//! They accept an `IggyClient` reference and return a `Result`.
//!
//! # Example
//!
//! ```ignore
//! use integration::{iggy_harness, harness::seeds};
//!
//! #[iggy_harness(mcp, seed = seeds::stream_only)]
//! async fn test_get_streams(mcp_client: McpClient) {
//!     // Stream already created by seed function
//! }
//! ```
