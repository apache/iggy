...
{CLAP_INDENT}
          ...
          (only stream ID is provided) all are set of false. Stream permission format consists
...
{CLAP_INDENT}
          ...
          all are set of false. Topic permission format consists of topic ID followed by colon (:)
