...
#[iggy_harness(server(
    system.segment.size = ["512B", "1KiB", "10MiB"],
    system.segment.cache_indexes = ["none", "all", "open_segment"],
    system.partition.messages_required_to_save = [32, 64, 1024, 9984],
))]
async fn get_by_timestamp(harness: &TestHarness) {
