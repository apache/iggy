...
use super::container_v3::{
    DEFAULT_TEST_STREAM_V3, DEFAULT_TEST_TOPIC_V3, ENV_V3_SOURCE_API_VERSION,
    ENV_V3_SOURCE_BATCH_SIZE, ENV_V3_SOURCE_CURSOR_FIELD, ENV_V3_SOURCE_DB, ENV_V3_SOURCE_ORG,
    ENV_V3_SOURCE_PATH, ENV_V3_SOURCE_PAYLOAD_FORMAT, ENV_V3_SOURCE_POLL_INTERVAL,
    ENV_V3_SOURCE_QUERY, ENV_V3_SOURCE_STREAMS_0_SCHEMA, ENV_V3_SOURCE_STREAMS_0_STREAM,
    ENV_V3_SOURCE_STREAMS_0_TOPIC, ENV_V3_SOURCE_TOKEN, ENV_V3_SOURCE_URL,
...
impl TestFixture for InfluxDb3SourceFixture {
    ...
    fn connectors_runtime_envs(&self) -> HashMap<String, String> {
        ...
        envs.insert(ENV_V3_SOURCE_API_VERSION.to_string(), "v3".to_string());
