...
pub const ENV_V3_SINK_API_VERSION: &str = "IGGY_CONNECTORS_SINK_INFLUXDB_PLUGIN_CONFIG_API_VERSION";
...
pub const ENV_V3_SOURCE_API_VERSION: &str =
    "IGGY_CONNECTORS_SOURCE_INFLUXDB_PLUGIN_CONFIG_API_VERSION";
