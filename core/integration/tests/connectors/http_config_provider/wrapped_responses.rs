...
use integration::harness::fixtures::WireMockWrappedFixture;
// TestHarness is used in function signatures for macro parameter detection
#[allow(unused_imports)]
use integration::harness::TestHarness;
use integration::iggy_harness;
use reqwest::StatusCode;

#[iggy_harness(server(connector(
    config_path = "tests/connectors/http_config_provider/config_wrapped.toml"
)))]
async fn source_configs_list_returns_all_versions(
    harness: &TestHarness,
    _fixture: WireMockWrappedFixture,
) {
