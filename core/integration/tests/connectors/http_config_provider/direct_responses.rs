...
use integration::harness::fixtures::WireMockDirectFixture;
...
#[iggy_harness(server(connector(
    config_path = "tests/connectors/http_config_provider/config_direct.toml"
)))]
async fn source_configs_list_returns_all_versions(
    harness: &TestHarness,
    _fixture: WireMockDirectFixture,
) {
