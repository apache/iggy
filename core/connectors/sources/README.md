...
pub struct SourceConfig {
    ...
    pub channel_capacity: Option<usize>, // Plugin -> runtime forwarding channel capacity in batches (default: 1024)
}
```
...
channel_capacity = 1024 # Plugin -> runtime forwarding channel capacity in batches
