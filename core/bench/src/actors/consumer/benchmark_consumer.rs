...
use crate::actors::consumer::client::ConsumerClient;
...
pub struct BenchmarkConsumer {
    pub client: Box<dyn ConsumerClient>,
...
impl BenchmarkConsumer {
    ...
    pub fn new(
        ...
        let (client, api_label): (Box<dyn ConsumerClient>, &'static str) = if use_high_level_api {
            (
