...
use crate::{
    actors::{
        consumer::{
            client::{BenchmarkConsumerConfig, ConsumerClient},
            high_level_client::HighLevelConsumerClient,
            low_level_client::LowLevelConsumerClient,
        },
        producer::{
            client::{BenchmarkProducerConfig, ProducerClient},
...
pub struct BenchmarkProducingConsumer {
    producer: Box<dyn ProducerClient>,
...
impl BenchmarkProducingConsumer {
    ...
    pub fn new(
        ...
        let (producer, consumer, api_label): (
            Box<dyn ProducerClient>,
            Box<dyn ConsumerClient>,
            &'static str,
