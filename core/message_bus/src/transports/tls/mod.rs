...
//!
//! This module hosts the credentials newtypes, PEM loaders, and the
//! idempotent rustls/ring crypto provider initializer used by the
//! in-process TCP-TLS and WSS transports. The hand-rolled
//! `UnbufferedConnection` driver lands alongside this file in
//! `transports/tls/driver.rs` (P9-T2).
//!
...
//! # Cross-references
//!
//! - `Documents/silverhand/iggy/message_bus/transport-plan/phases/phase-9-unified-tls-driver.md`
//!   (spec)
