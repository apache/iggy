...
// =====================================================================
// Personal access token mapping functions
// =====================================================================
...
// =====================================================================
// SharedMetadata-based mapping functions
// =====================================================================
...
pub fn map_consumer_groups_from_metadata(
    ...
    let mut group_ids: Vec<_> = topic_meta.consumer_groups.keys().collect();
...
fn aggregate_stream_stats(stream_meta: &StreamMeta) -> (u64, u64) {
    ...
    for (_, topic_meta) in stream_meta.topics.iter() {
        for (_, partition_meta) in topic_meta.partitions.iter() {
