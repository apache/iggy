...
async fn create_personal_access_token(
    ...
    let request = ShardRequest::control_plane(ShardRequestPayload::CreatePersonalAccessToken {
...
async fn delete_personal_access_token(
    ...
    let request = ShardRequest::control_plane(ShardRequestPayload::DeletePersonalAccessToken {
        user_id: identity.user_id,
        name,
    });
