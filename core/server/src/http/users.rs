...
async fn create_user(
    ...
    let request = ShardRequest::control_plane(ShardRequestPayload::CreateUser {
...
async fn update_user(
    ...
    let request = ShardRequest::control_plane(ShardRequestPayload::UpdateUser {
...
async fn update_permissions(
    ...
    let request = ShardRequest::control_plane(ShardRequestPayload::UpdatePermissions {
        session_user_id: identity.user_id,
        user_id: command.user_id,
        permissions: command.permissions,
    });
...
async fn change_password(
    ...
    let request = ShardRequest::control_plane(ShardRequestPayload::ChangePassword {
        session_user_id: identity.user_id,
        user_id: command.user_id,
...
async fn delete_user(
    ...
    let request = ShardRequest::control_plane(ShardRequestPayload::DeleteUser {
        session_user_id: identity.user_id,
        user_id,
    });
