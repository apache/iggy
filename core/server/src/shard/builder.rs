...
use super::{
    IggyShard, TaskRegistry, shard_local_partitions::ShardLocalPartitions,
    transmission::connector::ShardConnector, transmission::frame::ShardFrame,
};
...
pub struct IggyShardBuilder {
    ...
    is_follower: bool,
    shared_metadata: Option<EternalPtr<Metadata>>,
}
...
impl IggyShardBuilder {
    ...
    pub fn shared_metadata(mut self, shared_metadata: EternalPtr<Metadata>) -> Self {
    ...
    pub fn build(self) -> IggyShard {
        ...
        let partition_store = RefCell::new(ShardLocalPartitions::new());
        ...
        IggyShard {
            ...
            partition_store,
            pending_partition_inits: RefCell::new(std::collections::HashSet::new()),
