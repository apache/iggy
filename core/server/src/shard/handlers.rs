...
async fn handle_request(
    ...
    match request.payload {
        ...
        ShardRequestPayload::CreateUser {
            ...
            let user = execution::execute_create_user(
                shard,
                session_user_id,
                username,
                password,
        ...
        ShardRequestPayload::DeleteUser {
            ...
            let user = execution::execute_delete_user(shard, session_user_id, user_id).await?;
        ...
        ShardRequestPayload::UpdatePermissions {
            ...
            execution::execute_update_permissions(shard, session_user_id, user_id, permissions)
                .await?;
        ...
        ShardRequestPayload::ChangePassword {
            ...
            execution::execute_change_password(
                shard,
                session_user_id,
                user_id,
                current_password,
        ...
        ShardRequestPayload::UpdateUser {
            ...
            let user =
                execution::execute_update_user(shard, session_user_id, user_id, username, status)
                    .await?;
        ...
        ShardRequestPayload::CreatePersonalAccessToken {
            ...
            let (personal_access_token, token) =
                execution::execute_create_personal_access_token(shard, user_id, name, expiry)
                    .await?;
        ...
        ShardRequestPayload::DeletePersonalAccessToken { user_id, name } => {
            ...
            execution::execute_delete_personal_access_token(shard, user_id, name).await?;
