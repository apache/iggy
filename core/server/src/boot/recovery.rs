...
pub(in crate::boot) async fn build_shard_for_thread(
    ...
    shard.set_gap_debounce_ticks(repair_gap_debounce_ticks(config));
...
mod tests {
    ...
    fn documented_gap_debounce_floor_matches_the_shard_constant() {
        ...
        assert_eq!(
            u128::from(shard::GAP_DEBOUNCE_TICKS_MIN) * shard::CONSENSUS_TICK_INTERVAL.as_millis(),
            500,
