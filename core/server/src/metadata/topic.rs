...
use crate::metadata::{ConsumerGroupId, DEFAULT_SLAB_SEGMENT_SIZE, TopicId};
...
pub struct TopicMeta {
    ...
    pub partitions: SegmentedSlab<PartitionMeta, DEFAULT_SLAB_SEGMENT_SIZE>,
    pub consumer_groups: SegmentedSlab<ConsumerGroupMeta, DEFAULT_SLAB_SEGMENT_SIZE>,
