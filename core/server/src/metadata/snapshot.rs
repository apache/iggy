...
use crate::metadata::{DEFAULT_SLAB_SEGMENT_SIZE, StreamId, StreamMeta, UserId, UserMeta};
...
pub struct InnerMetadata {
    ...
    pub streams: SegmentedSlab<StreamMeta, DEFAULT_SLAB_SEGMENT_SIZE>,

    /// Users indexed by UserId (slab-assigned)
    pub users: SegmentedSlab<UserMeta, DEFAULT_SLAB_SEGMENT_SIZE>,
