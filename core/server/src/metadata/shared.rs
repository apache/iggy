...
/// Thread-safe wrapper for global metadata using ArcSwap for lock-free reads.
...
impl Metadata {
    ...
    pub fn update_stream(&self, id: StreamId, new_name: Arc<str>) -> Result<(), IggyError> {
...
mod tests {
    ...
    fn test_stream_crud() {
        ...
        metadata
            .update_stream(id, Arc::from("renamed-stream"))
            .unwrap();
