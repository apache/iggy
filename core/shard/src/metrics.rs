...
impl ShardMetrics {
    ...
    /// Snapshot of the replica read counters. Test accessor.
    #[must_use]
    pub fn replica_read_counts(&self) -> (u64, u64) {
        (
            self.replica_socket_reads_total.get(),
            self.replica_inbound_frames_total.get(),
        )
    }
