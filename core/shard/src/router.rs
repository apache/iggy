    ...
    SB: SuperblockStore,
{
    ...
    /// the two forward-register frames, which no retransmit covers: a dropped
    /// forward or its result surfaces as the origin's forward timeout plus the
    /// SDK's login replay. A
